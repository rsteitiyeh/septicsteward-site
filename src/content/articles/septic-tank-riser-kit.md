---
title: "Septic tank riser kit: costs, types, and why it pays for itself"
description: "Septic tank riser kit: costs, types, and why it pays for itself"
...
| ------------------ | ---------------------------------------------------------------------------- |
| **Field**          | **Value**                                                                    |
| Primary keyword    | septic tank riser kit                                                        |
| Secondary keywords | septic tank riser installation, septic riser cost, polyethylene septic riser |
| Slug               | septic-tank-riser-kit                                                        |
...
A $250 DIY riser kit erases those fees permanently, usually paying for itself by the second pump out. It also means an inspector can check your tank in five minutes during a home sale instead of quoting you an excavation. We break down what inspectors look for at SepticSteward/septic-inspection.

![](/media/7381c2dd6fd65f77de82226ad32d33da42fd74dd.png)
...
This is a reasonable weekend job for one person on a shallow tank. Budget 2 to 4 hours the first time.
  ...
  - Locate and expose the tank access lid; dig a working area about a foot wider than the opening

  - Clean the tank surface around the opening with a wire brush so sealant can bond

  - Dry fit the adapter ring or first riser section and check it sits level

  - Apply butyl rope or the kit's sealant and set the adapter; screw it down if your kit anchors to concrete

  - Stack and seal each ring, checking level as you go, until the top ring reaches your target height

  - Attach the safety pan if included, then bolt on the lid with the stainless hardware

  - Backfill around the riser in layers, tamping as you go, and slope soil slightly away from the lid
...
## Mistakes we see over and over
  ...
  - Skipping the safety pan on a lid kids can reach

  - Leaving the finished lid below grade in a low spot where rain ponds

  - Sealing rings with silicone caulk instead of butyl; it peels off polyethylene within a couple of seasons

  - Installing a riser over only one of two access openings; pumpers want the inlet and outlet both reachable

That last one matters more than people think. Many tanks have two lids, one over each baffle, and a proper cleanout uses both. If your budget allows, riser both openings. If not, riser the outlet side first since that's where the effluent filter lives, and while the tank is open it's worth checking the sizes and filter fit against your tank capacity with the free SepticSteward/calculator tool. Not sure if your tank even has a filter? Our piece at SepticSteward/septic-tank-filter shows what to look for.
