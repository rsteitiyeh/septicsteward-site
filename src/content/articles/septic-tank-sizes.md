---
title: "Septic tank sizes: what size tank your house actually needs"
description: "Septic tank sizes: what size tank your house actually needs"
...
| ------------------ | ----------------------------------------------------------------- |
| **Field**          | **Value**                                                         |
| Primary keyword    | septic tank sizes                                                 |
| Secondary keywords | septic tank size calculator, septic tank size for 3 bedroom house |
| Slug               | septic-tank-sizes                                                 |
...
![](/media/33d42d54fa65ff1b5f7196afba910dfbbf482690.png)
...
Upsize a step if any of these apply to you:
  ...
  - Garbage disposal: most codes bump you one tank size because ground food scraps add solids fast

  - High water fixtures: jetted tubs, multi head showers, or an oversized washing machine

  - Home business with water use, like a salon or daycare

  - Frequent guests or multigenerational living beyond the two per bedroom assumption

  - Plans to add a bedroom or accessory dwelling later; permits are easier now than after

The garbage disposal rule surprises people. Disposals can increase the solids entering your tank by 40 to 50 percent, which fills the sludge layer faster and shortens the time before solids escape to the drain field. If you run one on a borderline sized tank, plan on more frequent pumping. We cover schedules and pricing at SepticSteward/septic-tank-pumping-service.
...
Buying a house with an existing system? Three ways to find the tank size, in order of reliability:
  ...
  - Pull the septic permit from your county health department; it lists tank capacity, material, and a site drawing

  - Ask your pumping company; the invoice usually states gallons pumped, which approximates capacity

  - Measure the tank at the next pump out: length x width x liquid depth in feet, times 7.5, equals gallons

That third method is rough but useful. An 8 ft by 5 ft tank with 4 ft of liquid depth works out to about 1,200 gallons. Close enough to plan pumping intervals. If you want the sizing logic, pump schedules, and inspection checklists in one place, our $19 homeowner guide at SepticSteward/guide covers all of it.
