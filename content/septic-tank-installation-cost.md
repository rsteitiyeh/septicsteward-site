...
| ------------------ | ------------------------------------------ |
| **Field**          | **Value**                                  |
| Primary keyword    | septic tank installation cost              |
| Secondary keywords | septic system cost, new septic system cost |
| Slug               | septic-tank-installation-cost              |
| Byline             | The SepticSteward Team (Trilot)                |
| Updated            | 2026-07-12                                 |
...
![](media/1269d075f8aedc96258b2698d1d01eaa2310c27a.png)
...
Concrete is the default: roughly $700 to $1,600 for 1,000 to 1,500 gallons, delivered. Polyethylene runs a bit less to buy and is easier to set, but some counties restrict it in high water table areas because empty plastic tanks can float. Fiberglass sits at the top of the range. Size follows bedroom count in nearly every state code; we mapped the size rules at SepticSteward/septic-tank-sizes.
...
The bid covers the system. These items live outside the bid, and at least one of them shows up on most projects.
  ...
  - Utility relocation or well setback conflicts discovered during design: $500 to several thousand.

  - Rock excavation surcharges, billed hourly once the machine hits ledge.

  - Landscaping repair. The yard after a septic install looks like a construction site because it was one. Seeding is usually included; sod, irrigation repair, and tree replacement are not.

  - Electrical runs for pumps and alarms on ATU and mound systems: $500 to $1,500 for a trenched circuit and panel work.

  - Winter surcharges for frost digging in cold climates.

  - The code-upgrade cascade on replacements: pull one permit and the county may require risers, a filter, and current setbacks on everything.
...
Sometimes only part of the system failed. If the tank is sound but the field is done, a field-only replacement saves the tank cost, though most counties require bringing the whole setup to current code once you pull a repair permit. That code-upgrade surprise is the most common budget overrun we hear about. The field-only math lives at SepticSteward/drain-field-repair.
...
What keeps the cost down (and what doesn't)
  ...
  - Get three bids against one approved design, so you're comparing identical scopes.

  - Schedule in the contractor's slow season where climate allows; winter and late fall bids often come in lower.

  - Handle simple site prep yourself where the contractor agrees: clearing brush, moving fences, marking utilities.

  - Right-size the tank to code, not beyond. Oversizing the tank adds cost with little benefit; oversizing the field is where extra money actually buys longevity.

  - Add risers and an effluent filter at install. They're cheap now and expensive to retrofit.

  - Don't cheap out on the perc test or design. A marginal design that fails in 8 years erases every dollar it saved.
...
That last number matters for planning. A $7,000 system with $350 pump-outs every 4 years costs about $180 a year to maintain. Skipping that schedule is how $7,000 systems become $20,000 replacements. Our pumping hub covers the schedule and costs at SepticSteward/septic-tank-pumping-service.
...
Expect 4 to 10 weeks from first call to final inspection, most of it waiting on permits. The dig itself usually takes 2 to 5 days.
  ...
  - Soil evaluation and perc test on the proposed field area.

  - System design based on the soil results, bedroom count, and setbacks from wells, water, and property lines.

  - Permit application and county review. This is the slow step: one week in easy counties, two months in strict ones.

  - Excavation, tank set, field construction, and plumbing connections.

  - County inspection of the open trenches before backfill. Never let a contractor backfill early; failing this inspection means digging it all up again.

  - Backfill, grading, and seeding. Then an as-built drawing goes on file, and you keep a copy forever.

Before you sign anything, get an independent look at the design and site plan. A pre-construction review is cheap compared to the cost of a field placed in the wrong corner of the lot. What that review covers is at SepticSteward/septic-inspection.

Not sure what size system your household actually needs? Our free calculator estimates tank size and daily flow from bedrooms and occupancy; run it before you talk to designers at SepticSteward/calculator. And if you want the full owner's manual for the system you're about to buy, from install decisions through year 20 maintenance, that's our $19 homeowner guide at SepticSteward/guide.
